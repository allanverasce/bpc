...
@Slf4j
public class DeleteToolFunction implements CallableFunction {

    /**
     * 
     * This class implements the {@link CallableFunction} interface and represents
     * the function that is responsible for deleting a tool from the system.<br>
     * <br>
     * The execution of this function will delete the tool from the database and set
    ...
    public void execute(FunctionContext context) {
        ...
        try {
            ...
            new ToolDao().delete(tool);
            message.setMessageStatus(MessageStatus.PROCESSED);
        } catch (Exception e) {
            log.error("Error to delete tool", e);
