...
@Slf4j
public class CheckSocketFunction implements CallableFunction {

  /**
   * This class implements the {@link CallableFunction} interface and represents
   * the function that is responsible check socket is open.<br>
   * <br>
   * The execution of this function will check socket is open and set
  ...
  public void execute(FunctionContext context) {
    ...
    try {
      ...
      log.error("Error to check socket", e);
